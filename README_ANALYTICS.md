...
**Definition:** Best possible entry price within the trade window.

- **LONG signals:** Lowest low between crossovers (best buy price)
- **SHORT signals:** Highest high between crossovers (best sell price)

**Example:**
```
LONG signal at $100
Window prices: $98 (low), $105 (high)
Optimal entry: $98 (could have entered 2% better)
```
